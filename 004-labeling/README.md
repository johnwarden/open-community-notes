...
To find posts with helpful notes or notes needing ratings, the app view will rely on labels.

### App Labeler Approach

- The Community Notes labeler can be configured as an **App Labeler**, or users can subscribe to the labeler.
...
- For posts with a 'annotation' label, the front-end will lookup the proposals that have been rated helpful by calling getProposals in the Community Notes service, and then display these as helpful community notes with the "Readers Added Context" header.
